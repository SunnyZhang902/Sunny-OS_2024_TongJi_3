...
class mainForm(QMainWindow): # 主窗体
    def __init__(self):
        ...
        self.tree.setStyleSheet("background-color: ivory;border: 0px;")

        # 添加竖线分隔符
        self.line = QFrame()
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.line.setStyleSheet("QFrame { width: 3px; background-color: darkmagenta; }") # 设置线条宽度和颜色
        ...
        self.listView.setStyleSheet("background-color: ivory ;border: 0px;") # 设置背景色

        # 加载当前路径文件
        self.loadCurFile()
        grid.addWidget(self.listView, 1, 2)
